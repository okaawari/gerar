...
CREATE TABLE `Order` (
    ...
    `deliveryTimeSlot` VARCHAR(5) NULL,
    ...
    INDEX `Order_deliveryTimeSlot_idx`(`deliveryTimeSlot`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Address` (
    ...
    `provinceOrDistrict` VARCHAR(191) NOT NULL,
    `khorooOrSoum` VARCHAR(191) NOT NULL,
    `street` VARCHAR(191) NULL,
    `neighborhood` VARCHAR(191) NULL,
    `residentialComplex` VARCHAR(191) NULL,
